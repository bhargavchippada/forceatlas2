...
class ForceAtlas2:
    def __init__(
        ...
        assert (
            adjustSizes == multiThreaded == False
    ...
    def forceatlas2_networkx_layout(
        self, G, pos=None, iterations=100, weight_attr=None
    ):
        import networkx
